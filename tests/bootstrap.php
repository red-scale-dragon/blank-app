...
require_once(realpath(__DIR__ . '/../vendor/yoast/phpunit-polyfills/phpunitpolyfills-autoload.php'));
...
require_once(realpath(__DIR__ . '/../vendor/red-scale-dragon/framework/tests/helpers.php'));
